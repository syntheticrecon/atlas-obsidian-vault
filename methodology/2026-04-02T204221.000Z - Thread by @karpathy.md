...
**Numman Ali** @nummanali [2026-04-02](https://x.com/nummanali/status/2039806239111106734)

Do like Obsidian though?

It felt like too much of a learning curve and not enough flexibility

I didn’t see the different with simply running VS Code with a Markdown Viewer

Are you going to stick with this set up or do you have a different go forward plan?

---

**Hunter** @huntsyea [2026-04-04](https://x.com/huntsyea/status/2040303732387156328)

Obsidian is one the most flexible apps on the planet?
